...
export const APP_VERSION = "v76";  // đồng bộ với CACHE trong sw.js

const VIEWS = {
  home: ui.renderHome,
  study: ui.renderStudy,
  vocabHub: ui.renderVocabHub,
  vocab: ui.renderVocab,
  wordsets: ui.renderWordsets,
  type: ui.renderType,
  quiz: ui.renderQuiz,
  examHub: ui.renderExamHub,
  exam: ui.renderExam,
...
const NAV = [
  ...
  { id: "vocab", label: "Từ vựng", icon: "cards", tabs: [
    { view: "vocabHub", label: "Từ vựng" },
    { view: "vocab", label: "Thư mục", hidden: true },
    { view: "wordsets", label: "Bộ của tôi", hidden: true },
    { view: "manage", label: "Nguồn từ", hidden: true },
  ...
  { id: "exam", label: "Luyện đề", icon: "exam", tabs: [
    { view: "examHub", label: "Luyện đề" },
    { view: "exam", label: "HSK", hidden: true },
    { view: "examHskk", label: "HSKK", hidden: true },
  ] },
  ...
  { id: "phon", label: "Phồn thể", icon: "trad", tabs: [
    { view: "tradHub", label: "Phồn thể" },
    { view: "tradHome", label: "Lộ trình", hidden: true },
    { view: "tradFolder", label: "Thư mục", hidden: true },
    { view: "tradSets", label: "Bộ của tôi", hidden: true },
    { view: "tradRules", label: "Bộ thủ", hidden: true },
